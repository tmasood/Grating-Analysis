/* ode.f -- translated by f2c (version 20000121).
...
/* Subroutine */ int ode_(f, neqn, y, t, tout, relerr, abserr, iflag, work, 
	iwork)
/* Subroutine */ int (*f) ();
integer *neqn;
doublereal *y, *t, *tout, *relerr, *abserr;
integer *iflag;
doublereal *work;
integer *iwork;
{
    ...
    extern /* Subroutine */ int de_();
    static integer ip, iypout, iyp, iwt, iyy;
...
/* *********************************************************************** */
    ...
    nornd = iwork[2] != -1;
L1:
    de_(f, neqn, &y[1], t, tout, relerr, abserr, iflag, &work[iyy], &work[iwt]
	    , &work[ip], &work[iyp], &work[iypout], &work[iphi], &work[ialpha]
	    , &work[ibeta], &work[isig], &work[iv], &work[iw], &work[ig], &
	    phase1, &work[ipsi], &work[ix], &work[ih], &work[ihold], &start, &
	    work[itold], &work[idelsn], &iwork[1], &nornd, &iwork[3], &iwork[
	    4], &iwork[5]);
    work[istart] = -1.;
    if (start) {
	work[istart] = 1.;
...
/* Subroutine */ int de_(f, neqn, y, t, tout, relerr, abserr, iflag, yy, wt, 
	p, yp, ypout, phi, alpha, beta, sig, v, w, g, phase1, psi, x, h__, 
	hold, start, told, delsgn, ns, nornd, k, kold, isnold)
/* Subroutine */ int (*f) ();
integer *neqn;
doublereal *y, *t, *tout, *relerr, *abserr;
integer *iflag;
doublereal *yy, *wt, *p, *yp, *ypout, *phi, *alpha, *beta, *sig, *v, *w, *g;
logical *phase1;
doublereal *psi, *x, *h__, *hold;
logical *start;
doublereal *told, *delsgn;
integer *ns;
logical *nornd;
integer *k, *kold, *isnold;
{
    /* Initialized data */
...
/* L110: */
    ...
    step_(x, &yy[1], f, neqn, h__, &eps, &wt[1], start, hold, k, kold, &crash,
	     &phi[phi_offset], &p[1], &yp[1], &psi[1], &alpha[1], &beta[1], &
	    sig[1], &v[1], &w[1], &g[1], phase1, ns, nornd);
...
/* Subroutine */ int step_(x, y, f, neqn, h__, eps, wt, start, hold, k, kold, 
	crash, phi, p, yp, psi, alpha, beta, sig, v, w, g, phase1, ns, nornd)
doublereal *x, *y;
/* Subroutine */ int (*f) ();
integer *neqn;
doublereal *h__, *eps, *wt;
logical *start;
doublereal *hold;
integer *k, *kold;
logical *crash;
doublereal *phi, *p, *yp, *psi, *alpha, *beta, *sig, *v, *w, *g;
logical *phase1;
integer *ns;
logical *nornd;
{
    ...
    static integer limit1, limit2, iq;
    static doublereal realns;
    static integer im1, km1, km2, ip1, kp1, kp2;
...
/* Subroutine */ int intrp_(x, y, xout, yout, ypout, neqn, kold, phi, psi)
doublereal *x, *y, *xout, *yout, *ypout;
integer *neqn, *kold;
doublereal *phi, *psi;
{
    /* Initialized data */
    ...
    /* Local variables */
    static doublereal term, temp1, temp2, temp3;
    static integer i__, j, l;
    static doublereal gamma, w[13];
    static integer limit1;
    static doublereal psijm1, hi;
