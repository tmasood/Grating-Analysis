/* cgetrf.f -- translated by f2c (version 19960717).
...
int cgetrf(integer *m, integer *n, complex *a,
	    integer *lda, integer *ipiv, integer *info)
{
    ...
    extern /* Subroutine */ int cgemm_();
    static integer iinfo;
    extern /* Subroutine */ int ctrsm_(), cgetf2_();
    static integer jb, nb;
    extern /* Subroutine */ int xerbla_();
    extern integer ilaenv_();
    extern /* Subroutine */ int claswp_();
