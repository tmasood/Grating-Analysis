/* i1mach.f -- translated by f2c (version 19961209).
...
integer *i__;
{
    ...
    static integer imach[16] = { 5,6,6,6,32,4,2,31,2147483647,2,24,-125,128,
	    53,-1021,1024 };
...
/* ***FIRST EXECUTABLE STATEMENT  I1MACH */
    if (*i__ < 1 || *i__ > 16) {
	xermsg_("SLATEC", "I1MACH", "I OUT OF BOUNDS", &c__1, &c__2, 6L, 6L, 
		15L);
    }
