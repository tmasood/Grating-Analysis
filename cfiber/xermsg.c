/* xermsg.f -- translated by f2c (version 19961209).
...
/* DECK XERMSG */
/* Subroutine */ int xermsg_(librar, subrou, messg, nerr, level, librar_len, 
...
ftnlen messg_len;
{
    ...
    static char xsubr[8];
    extern integer j4save_();
    static integer llevel, maxmes;
    static char lfirst[20];
    extern /* Subroutine */ int xercnt_();
    static integer lkntrl, kdummy;
    extern /* Subroutine */ int xerhlt_();
    static integer mkntrl;
    extern /* Subroutine */ int xersve_(), xerprn_();
...
NUMBER OR LEVEL$$ JOB ABORT DUE TO FATAL ERROR.", &c__72, 4L, 91L);
