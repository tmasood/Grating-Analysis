/* cbesh.f -- translated by f2c (version 20000121).
...
/* DECK CBESH */
/* Subroutine */ int cbesh_(complex *z__, real *fnu, integer *kode,
			    integer *m, integer *n, complex *cy, 
			    integer *nz, integer *ierr)
{
    ...
    /* Builtin functions */
    double r_imag(), c_abs(), sqrt(), log(), r_sign(), cos(), sin();
    ...
    extern int cuoik_(complex *, real *, integer *,
			    integer *, integer *, complex *,
			    integer *, real *, real *, real *);
