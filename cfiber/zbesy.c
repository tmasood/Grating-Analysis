/* zbesy.f -- translated by f2c (version 20000121).
...
/* DECK ZBESY */
/* Subroutine */ int zbesy_(zr, zi, fnu, kode, n, cyr, cyi, nz, cwrkr, cwrki, 
	ierr)
doublereal *zr, *zi, *fnu;
integer *kode, *n;
doublereal *cyr, *cyi;
integer *nz;
doublereal *cwrkr, *cwrki;
integer *ierr;
{
    ...
    static doublereal exi, r1m5, exr, sti, tay, tol, str;
