...
int firstcoeffalt(int nbound, real betaR, real nu, real k0, real *index, real *wrb, real *M_x)
{
  ...
  real EigVect[SIZE - 1];
  real M0[SIZE][SIZE];
  real besjm0[SIZE], besjpm0[SIZE],besim0[SIZE], besipm0[SIZE];
  real beskcm[SIZE], beskpcm[SIZE];
  real gamma2;
  real gamma;
  real z2, z1;
  real kappa;
